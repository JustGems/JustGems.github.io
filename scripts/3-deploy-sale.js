...
async function main() {
  ...
  console.log('Deploying JustGemsSale ...')
  const sale = await deploy('JustGemsSale', nft.address, admin.address)

  console.log('')
  console.log('-----------------------------------')
  console.log('JustGemsSale deployed to:', sale.address)
  console.log('')
  console.log('Roles: FUNDER_ROLE, CURATOR_ROLE')
  console.log('')
  console.log(
  ...
  console.log('In JustGemsSale contract, grant CURATOR_ROLE, FUNDER_ROLE to admin (choose another wallet)')
  ...
  console.log('In JustGems contract, grant MINTER_ROLE to JustGemsSale')
  console.log(` - ${network.scanner}/address/${nft.address}#writeContract`)
  console.log(` - grantRole( ${getRole('MINTER_ROLE')}, ${sale.address} )`)
  console.log('')
}
