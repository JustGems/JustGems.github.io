...
// $ npx hardhat run scripts/1-deploy-nft.js
...
async function main() {
  ...
  console.log('Deploying JustGems ...')
  const nft = await deploy('JustGems', admin.address)

  console.log('')
  console.log('-----------------------------------')
  console.log('JustGems deployed to:', nft.address)
  console.log('')
  console.log('Roles: MINTER_ROLE, CURATOR_ROLE, BURNER_ROLE')
  console.log('')
  console.log(
  ...
  console.log('In JustGems contract, grant CURATOR_ROLE to admin (choose another wallet)')
